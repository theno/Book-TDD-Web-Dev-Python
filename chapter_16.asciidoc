...
3.3
footnote:[If you're using Python 3.2, upgrade!  Or if you're stuck with it,
...
footnote:[I actually recently found out that you can just assign
...
Let's go all the way and make the email field into the primary key, and
