...
docs, or there's a good guide
http://coding.smashingmagazine.com/2013/03/12/customizing-bootstrap/[here].
...
the bootstrap documentation yourself, but should be able to use a combination
...
Hm. no.  Why isn't our CSS loading?
...
All that took me a few goes, but I'm reasonably happy with it now, as in
<<homepage-looking-better>>.

[[homepage-looking-better]]
.The lists page, with all big chunks...
image::images/screenshot_good_enough.png[Screenshot of lists page with big styling]
...
The destination, the place where static files are collected to, is defined in
