...
In <<manual-validation-chapter>> & <<simple-form-chapter>> we saw that you can
...
docs properly), and even one point switching to dev version of Django to
overcome a bug
...
image::images/debugging_ajax.png["Shows the Firefox debug console open on the network tab"]
